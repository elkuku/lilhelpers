 ...
 * @version   CVS: $Id: FunctionCommentSniff.php 8 2010-11-06 00:40:23Z elkuku $
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class KuKu_Sniffs_Commenting_FunctionCommentSniff implements PHP_CodeSniffer_Sniff
{
    /**
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if(preg_match('|[A-Z_]|', $testShort[0]) === 0)
        {
            ...
            foreach($params as $param)
            {
                ...
                if($previousParam !== null)
                {
                    ...
                    /*
                     ...
                     $error = 'The variable names for parameters '
                     .$previousName.' ('.($pos - 1).') and '.$paramName.' ('.$pos.') do not align';
                     $this->currentFile->addError($error, $errorPos);
                     }
