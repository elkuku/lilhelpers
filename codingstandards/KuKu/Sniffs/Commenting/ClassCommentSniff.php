 ...
 * @version   CVS: $Id: ClassCommentSniff.php 8 2010-11-06 00:40:23Z elkuku $
...
/**
 * Parses and verifies the class DocComment.
 *
 * Verifies that :
 * <ul>
 *  <li>A class DocComment exists.</li>
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class KuKu_Sniffs_Commenting_ClassCommentSniff implements PHP_CodeSniffer_Sniff
{
    /**
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if(empty($long) === false)
        {
            ...
            if(preg_match('|[A-Z\_]|', $testLong[0]) === 0)
            {
                $error = 'xClass comment long description must start with a capital letter';
        ...
        if(preg_match('|[A-Z\_]|', $testShort[0]) === 0)
        {
