 ...
 * @version   CVS: $Id: FunctionCallSignatureSniff.php 8 2010-11-06 00:40:23Z elkuku $
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class KuKu_Sniffs_Functions_FunctionCallSignatureSniff implements PHP_CodeSniffer_Sniff
{
    /**
     ...
     * @param integer                  $stackPtr    The position of the current token
     *                                          in the stack passed in $tokens.
     * @param integer                  $openBracket The position of the openning bracket
     *                                          in the stack passed in $tokens.
