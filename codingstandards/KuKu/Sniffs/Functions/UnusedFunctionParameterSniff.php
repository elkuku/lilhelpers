 ...
 * @version   CVS: $Id: UnusedFunctionParameterSniff.php 8 2010-11-06 00:40:23Z elkuku $
 ...
 * of them.
 *
 * function foo(<b class="warn">$bar</b>)
 * {
 *    $x = 'Y';
 * }//function
 *
 * The parameter "$bar" is not used anywhere inside the function.
 *
 * @category  PHP
 * @package   PHP_CodeSniffer
 * @author    Manuel Pichler <mapi@manuel-pichler.de>
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class KuKu_Sniffs_Functions_UnusedFunctionParameterSniff implements PHP_CodeSniffer_Sniff
{
    /**
