 ...
 * @version   CVS: $Id: NestingLevelSniff.php 8 2010-11-06 00:40:23Z elkuku $
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class KuKu_Sniffs_Metrics_NestingLevelSniff implements PHP_CodeSniffer_Sniff
{
    /**
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        {
            $error = sprintf('Function\'s nesting level (%s) exceeds allowed maximum of %s'
        ...
        {
            $warning = sprintf('Function\'s nesting level (%s) exceeds %s; consider refactoring the function'
