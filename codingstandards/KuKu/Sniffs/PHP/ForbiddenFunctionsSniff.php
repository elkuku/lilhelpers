 ...
 *
 * <b class="bad">sizeof()</b> => <b class="good">count()</b>
 * <b class="bad">delete()</b> => <b class="good">unset()</b>
 *
 * @category  PHP
 * @package   PHP_CodeSniffer
 * @author    Greg Sherwood <gsherwood@squiz.net>
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class KuKu_Sniffs_PHP_ForbiddenFunctionsSniff implements PHP_CodeSniffer_Sniff
{
    /**
