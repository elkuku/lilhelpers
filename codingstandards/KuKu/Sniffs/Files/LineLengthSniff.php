 ...
 * @version   CVS: $Id: LineLengthSniff.php 8 2010-11-06 00:40:23Z elkuku $
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */

/**
 * Checks all lines in the file, and throws warnings if they are over 105
 * characters in length and errors if they are over 125.
 *
 * Line lengths:
 * <b class="warn">> 105</b>
 * <b class="bad">> 125</b>
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class KuKu_Sniffs_Files_LineLengthSniff implements PHP_CodeSniffer_Sniff
{
    /**
    ...
    protected function checkLineLength(PHP_CodeSniffer_File $phpcsFile, $stackPtr, $lineContent)
    {
        ...
        //-- Also our multilanguage function jgettext() produces strings
        //-- that are hard to break up..
        && preg_match('|jgettext\s*\(|', $lineContent) === 0
        )
        {
            ...
            {
                $error = sprintf('Line exceeds maximum limit of %s characters;'
            ...
            {
                $warning = sprintf('Line exceeds %s characters; contains %s characters'
