...
/**
 * Makes sure there are no spaces between the concatenation operator <b>.</b> and the strings being concatenated.
 *
 * Example:
 * <b class="bad">$a = $b . $c;</b>
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class KuKu_Sniffs_WhiteSpace_ConcatenationSpacingSniff implements PHP_CodeSniffer_Sniff
{
    /**
