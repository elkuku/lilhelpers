 ...
 * @version   CVS: $Id: ScopeKeywordSpacingSniff.php 8 2010-11-06 00:40:23Z elkuku $
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class KuKu_Sniffs_WhiteSpace_ScopeKeywordSpacingSniff implements PHP_CodeSniffer_Sniff
{
    /**
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        {
            $error = sprintf('Scope keyword "%s" must be followed by a single space'
